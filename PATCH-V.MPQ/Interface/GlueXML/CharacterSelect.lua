...
function CharacterSelect_OnLoad(self)
  ...
  local width = GlueParent:GetSize()
	local height = GlueParent:GetHeight()

	--[[light = {1, 0, 0, -0.707, -0.707, 0.7, 1.0, 1.0, 1.0, 0.8, 1.0, 1.0, 0.8}
	mod:SetModel("world/generic/human/passive doodads/banners/allianceveteranbanner01.m2")
	mod:SetSize(width,width/16*9)
	mod:SetPoint("CENTER")
	mod:SetPosition(0.3,0.6,40)
	mod:SetCamera(1)
