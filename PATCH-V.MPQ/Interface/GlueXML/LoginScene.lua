...
ModelList = {
	...
	blend_start_duration = 2,						-- beginning fade animation duration in seconds
	max_scenes = 3,									-- number of scenes you use to shuffle through
	fade_duration = 1,								-- fade animation duration in seconds (to next scene if more than 1 exists)
	current_scene = 3,								-- current scene that gets displayed
	...
	login_music_path = "Interface/Loginscreen/Music/huntcraftsong_spinup.mp3",						-- path to the music / false if no music
	login_ambience_name = "Interface/Loginscreen/Music/hunt_ambient.mp3",	-- name in SoundEntries.dbc / false if no ambience
	sceneData = {
		{-1, "Interface/Loginscreen/background.blp"},
		{-1, {0.7,0.7,0.7,1}},
		{-1, "Interface/Loginscreen/background4_wide_color.blp"}
	},
...
-- id,x,y,z,o,s,a
	...
	{3, 0.6, 0.2, -1.6, 6.18, 1.65, 1, _, 0, 1, 1, "world/generic/orc/passive doodads/voodoostuff/skullcandle01.m2", 1000,_},
	{3, 0.081, 0.863, -2.7, 0.745, 0.35, 1, _, 0, 1, 1, "world/generic/human/passive doodads/banners/allianceveteranbanner01.m2", 1000,_},
	...
	{2, 1.183, -0.132, 0, 0.745, 0.266, 1, _, 0, 1, 1, "world/azeroth/duskwood/passivedoodads/bush/duskwoodbush03.m2", 1000,_},
	{2, -0.445, -0.04, 0, 6.17, 0.2, 1, _, 0, 1, 1, "world/azeroth/duskwood/passivedoodads/bush/duskwoodbush03.m2", 1000,_},
...
function Scene_OnStart(sceneID)
	PlayMusic("Interface/Loginscreen/Music/huntcraftsong_spinup_ambient.mp3")
	if sceneID == 1 then
