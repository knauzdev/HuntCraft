...
RaceLights = {
    HUMAN =  {
        {1,     0,  0.000000,       0.000000,       -1.000000,   1.0,   0.11,       0.11,       .27,        0.3,    0,          0,          0},
        {1,     0,  -0.45756075,    -0.58900136,    -0.66611975, 1.0,   0.000000,   0.000000,   0.000000,   0.3,    0.19882353, 0.34921569, 0.43588236 },
        {1,     0,  -0.64623469,    0.57582057,     -0.50081086, 1.0,   0.000000,   0.000000,   0.000000,   0.3,    0.52196085, 0.44,       0.29764709 },
    },
    ORC = {
...
function SetBackgroundModel(model, name)
    ...
    local path = "Interface\\GLUES\\MODELS\\UI_CharacterSelect\\UI_CharacterSelect.M2";
    local path = "Interface\\Glues\\Models\\UI_SCOURGE\\UI_SCOURGE.m2";
